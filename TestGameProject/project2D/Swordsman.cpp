...
Swordsman::Swordsman()
{
	m_eUnitType = Unit::UType::Swordsman;
}

Swordsman::Swordsman(Tile* pLocation, Empire* pTeam)
{
...
void Swordsman::Initialise(Tile* pLocation, Empire* pTeam)
{
...
void Swordsman::Update(float fDeltaTime)
{
	MilitaryUnit::Update(fDeltaTime);
}

void Swordsman::Draw(aie::Renderer2D* pRenderer)
{
...
void Swordsman::Upgrade(Icon::IType eUpgrade)
{
...
void Swordsman::AttackBuilding(float fDeltaTime)
{
...
void Swordsman::AttackUnit(float fDeltaTime)
{
